...
public class TicketBean {
	...
	public TicketBean(String ticketID, String custID, String troubleID,
			String ticketDescription, String ticketType, java.util.Date d,
			java.util.Date d2, java.util.Date due, String remarks,
		...
		this.ticketDescription = ticketDescription;
		this.ticketType = ticketType;
		this.creationDate = (Date) d;
		this.lastUpdated = (Date) d2;
		this.dueDate = (Date) due;
		this.remarks = remarks;
		this.dispositionID = dispositionID;
		this.ticketStatus = ticketStatus;
		this.groupTicketID = groupTicketID;
